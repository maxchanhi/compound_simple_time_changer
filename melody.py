from notation import durations_fraction, setting_generation,adjust_rhythms_pitch,correct_tran_time_sign,equal_list,key_list,value_list
from score_gen import score_generation,remove_duplication
